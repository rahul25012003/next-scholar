 ...
 * deliberately small: fifteen institutions whose pages have been read is worth
...
export const catalogueScope = {
  ...
  note: "Fifteen institutions and thirty programmes, seeded by hand across the three destinations this business covers in full. It is not a complete list of universities in those countries and it does not claim to be. Institutions are added when their page has been read, not when a feed makes them available.",
  omissions: [
    "No institution appears here because it pays us. Six of the fifteen pay us nothing at all, and they are on the list for the same reason as the rest.",
