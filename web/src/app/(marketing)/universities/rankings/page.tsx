...
export const metadata: Metadata = {
  title: "Rankings",
  description:
    "Every ranking published for the thirty-four institutions in our catalogue, each naming its own body and year. Sorted alphabetically, never by rank, because comparing a rank from one body against a rank from another would be inventing a number nobody published.",
      ...
      <section className="band bg-paper">
        <div className="shell">
          ...
          <p className="mt-6 max-w-2xl text-[0.875rem] leading-relaxed text-muted">
            Thirty-four institutions, seeded by hand. See{" "}
