...
export const metadata: Metadata = {
  ...
  description:
    "Thirty courses across fifteen universities in the UK, Germany and Ireland. Every row shows what we earn if you enrol there, including the six institutions that pay us nothing.",
            ...
            {rows.length === 0 ? (
              <div className="mt-6 rounded-panel border border-dashed border-line-strong bg-surface p-8">
                ...
                <p className="mt-2 max-w-2xl text-[0.9375rem] leading-relaxed text-body">
                  ...
                  fifteen institutions across three destinations, seeded by hand, so an empty
