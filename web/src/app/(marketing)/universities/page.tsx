...
export const metadata: Metadata = {
  ...
  description:
    "Thirty-seven courses across thirty universities in the UK, Germany and Ireland. Every row shows what we earn if you enrol there, including the nine institutions that pay us nothing.",
  ...
  return (
    <>
      <PageHero
        ...
        lede="Thirty universities, thirty-seven courses, three destinations. The number neither of the two largest platforms in this market prints anywhere is on every row of this list, next to the fee, because they are the same kind of fact and you are entitled to both."
        aside={
            ...
            {rows.length === 0 ? (
              <div className="mt-6 rounded-panel border border-dashed border-line-strong bg-surface p-8">
                ...
                <p className="mt-2 max-w-2xl text-[0.9375rem] leading-relaxed text-body">
                  ...
                  thirty institutions across three destinations, seeded by hand, so an empty
