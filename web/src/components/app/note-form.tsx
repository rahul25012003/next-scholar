...
export function NoteForm({ caseId }: { caseId: string }) {
  ...
  return (
    <form action={formAction} className="px-6 py-5">
      ...
      <label htmlFor="note" className="text-[0.875rem] font-medium text-navy-900">
        Add a note
      </label>
      ...
      {state.status === "saved" && (
        <div className="mt-4 flex items-start gap-2.5 rounded-card border border-line bg-surface p-4" role="status">
