...
is nothing to cache. The whole catalogue is twenty-four institutions and
thirty-one programmes held in memory, with no external fetch anywhere in the path, and
